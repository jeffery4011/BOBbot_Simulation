...
void Ring::update_internal_force(){
    ...
    for (int i=1;i<n;i++){
        ...
        std::cout<<"Velocity:"<<dis.product(-1*damping_coefficient*(dis.dot(velocity_relative))).x<<" "<<dis.product(-1*damping_coefficient*(dis.dot(velocity_relative))).y<<std::endl;
